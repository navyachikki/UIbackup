...
var strings = ['U', 'L', 'N'];
            ...
            var generateCapthcaText = () => {
                ...
                console.log(capthcaText);
                document.querySelector("#capthcaText").innerText = capthcaText;
            }          

           

            // console.log(generateLowerCaseRandomChar());
            // console.log(generateUpperCaseRandomChar());
